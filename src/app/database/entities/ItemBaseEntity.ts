...
export class ItemBaseEntity
{
    ...
    @Column({ name: 'interaction', type: 'enum', enum: ['default', 'roller', 'teleport', 'exchange', 'gate', 'multi_height', 'dice', 'vending_machine', 'wf_trg_says_something', 'wf_act_teleport_to', 'pet_jump', 'wf_trg_state_changed'], default: 'default' })
