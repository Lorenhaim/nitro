...
import { CatalogLayout, CatalogLayouts, ClubBuyLayout, DefaultLayout, FrontPageFeaturedLayout, FrontPageLayout, GroupFrontpageLayout, SpacesNewLayout } from './layouts';
